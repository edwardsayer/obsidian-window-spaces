...
console.log('   Windows: %APPDATA%\\Obsidian\\{vault-name}\\.obsidian\\plugins\\window-spaces\\');
console.log('   macOS: ~/Library/Application Support/Obsidian/{vault-name}/.obsidian/plugins/window-spaces/');
console.log('   Linux: ~/.config/obsidian/{vault-name}/.obsidian/plugins/window-spaces/');
console.log('');
